/*
 * DO NOT MODIFY
 * This driver is taken from AirMouse, and is confirmed working.
 * Patching this driver may result in application instability.
 */
...
bool icm42688p_who_am_i_ok(ICM42688P* icm42688p) {
    uint8_t val = 0;
    icm42688p_read_reg(icm42688p->spi_bus, ICM42688_WHO_AM_I, &val);
    return val == ICM42688_WHOAMI;
}

void icm42688p_enable_sensors(ICM42688P* icm42688p) {
    icm42688p_write_reg(icm42688p->spi_bus, ICM42688_REG_BANK_SEL, 0);
    icm42688p_write_reg(
        icm42688p->spi_bus,
        ICM42688_PWR_MGMT0,
